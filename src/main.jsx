  ...
  <StrictMode>
    <HashRouter>
      <Routes>
        ...
        <Route path="/ASG-22" element={<Assignment_22 />}></Route>
        <Route path="/ASG-23" element={<Assignment_23 />}></Route>
        <Route path="/ASG-24" element={<Assignment_24 />}></Route>
        <Route path="/ASG-25" element={<Assignment_25 />}></Route>
        <Route path="/ASG-26" element={<Assignment_26 />}></Route>
        <Route path="/ASG-27" element={<Assignment_27 />}></Route>
        <Route path="/ASG-28" element={<Assignment_28 />}></Route>
        <Route path="/ASG-29" element={<Assignment_29 />}></Route>
        <Route path="/ASG-30" element={<Assignment_30 />}></Route>
      </Routes>
    </HashRouter>
  </StrictMode>
);
